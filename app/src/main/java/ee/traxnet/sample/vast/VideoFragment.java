...
public class VideoFragment extends Fragment {
    ...
    public void loadVideo() {
        ...
        mVideoPlayerController.setContentVideo("https://storage.backtory.com/traxnet-server/sdk/VASTContentVideo.mp4");
        mVideoPlayerController.setAdTagUrl(TraxnetVast.getAdTag(this.getContext(), BuildConfig.traxnetVastZoneId, TraxnetVast.PREROLL_TYPE_BOTH, TraxnetVast.VAST_VERSION_3));
    }
