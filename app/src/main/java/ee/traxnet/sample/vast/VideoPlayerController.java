...
package ee.traxnet.sample.vast;
...
import ee.traxnet.sdk.vast.AdEvent;
import ee.traxnet.sdk.vast.TraxnetVast;
import ee.traxnet.sdk.vast.TraxnetVastAdsListener;
...
public class VideoPlayerController {
    ...
    public VideoPlayerController(Context context,
        ...
        traxnetVast = new TraxnetVast(context, language);

        traxnetVast.setTraxnetVastAdsListener(new TraxnetVastAdsListener() {
            @Override
...
//        traxnetVast.setVideoAdPlayer(mVideoPlayerWithAdPlayback.getVideoAdPlayer());
        traxnetVast.requestAds(mVideoPlayerWithAdPlayback.getVideoAdPlayer(), mVideoPlayerWithAdPlayback.getAdUiContainer(),
    ...
    public void pause() {
        ...
        if (traxnetVast != null && mVideoPlayerWithAdPlayback.getIsAdDisplayed()) {
            traxnetVast.pause();
        } else {
