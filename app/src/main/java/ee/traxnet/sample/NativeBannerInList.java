...
import ee.traxnet.sample.adapter.NativeBannerAdapter;
...
public class NativeBannerInList extends AppCompatActivity {
    ...
    private void restoreState(Bundle savedInstanceState) {
        TraxnetNativeBannerManager.onRestoreInstanceState(this,
                BuildConfig.traxnetNativeBannerZoneId, savedInstanceState);
    ...
    private void initAdCache() {
        TraxnetNativeBannerManager.createCache(this,
                BuildConfig.traxnetNativeBannerZoneId, CacheSize.MEDIUM);
    }
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        TraxnetNativeBannerManager.onSaveInstanceState(this,
                BuildConfig.traxnetNativeBannerZoneId, outState);
